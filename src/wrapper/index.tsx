    ...
    <>
      <Routes>
        <Route path="/" element={<Home />}>
          ...
          <Route path="/patient/examinationInfor" element={<ExamInfor/>}/>
          <Route path="/patient/reExamination" element ={<ReExamination/>}/>
          <Route path="/user" element={<User />} />
          <Route path="/surgeryCalendar" element={<SurgeryCalendar />} />
          <Route path="/patients" element={<Patients />} />
          <Route path="/patients/detail" element={<PatientDetail/>} />
